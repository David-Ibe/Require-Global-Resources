...
import { getCardLabel, type CardLabel } from "@/lib/featured-listing";
...
function CardLabelBadge({ label }: { label: CardLabel }) {
  return (
...
export function ListingCard({ listing, className, featuredSlug }: Props) {
  ...
  const cardLabel = getCardLabel(listing, featuredSlug);
